Begin with a heading "Exploring Natural Wonders."

Write a paragraph describing breathtaking natural landscapes around the world.

Organize the following natural wonders and their countries in an ordered list (<ol>):
...
One image with Relative URL (download the image file victoria-falls.jpg then give path to it in src)
One image with Absolute URL (put this link in src)
Use appropriate attributes including alt, title, width, and height.
